...
```env
# Get API key from: https://command.new/saatvikbalyan/job-scout-ai-agent-e092?tab=api
...
```env
# Get API key from: https://command.new/saatvikbalyan/job-scout-ai-agent-e092
LANGBASE_API_KEY=your_langbase_api_key_here
